...
//Глава 8
//8.1 Берем самую большую коробку и заполняем ей пространство. Не будет оптимальным
//8.2 Берем самую нами желаемую достопримечательность, едем туда. Берем следующую и едем туда если осталось время и тд. Нет не будет оптимальным
//8.3 Нет
//8.4 Да
//8.5 Да
//8.6 Да
...
//Глава 10
//10.2 Добавить значения, чтобы повысить вес оценки.
//10.3 Конечно мало, так как фильмов слишком много и результаты скорее всего будут неправильными.
